...
//    func fetchTournamentDetails(id: String) async throws -> Tournament { return Tournament(id: "", name: "", courts: 1, numberOfGroups: 1, setType: .short, status: .draft, createdAt: Date(), courtAssignmentStrategy: .automatic) }
...
//    func listenToMatches(tournamentId: String, completion: @escaping ([Match]) -> Void) -> ListenerRegistration { return MockListenerRegistration() }
//    func listenToTournament(tournamentId: String, completion: @escaping (Tournament?) -> Void) -> ListenerRegistration { return MockListenerRegistration() }
//}
//
